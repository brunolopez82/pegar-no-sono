...
A simetria é a característica que a define, e é também a razão pela qual funciona de forma diferente das outras. Ao contrário do [método 4-7-8](/artigos/metodo-4-7-8-para-adormecer/), aqui a expiração **não** é mais longa do que a inspiração. Isto não é um pormenor: é a diferença entre uma técnica que acalma e uma técnica que estabiliza.
...
Se está a montar uma rotina, esta é a ordem que faz sentido: **respiração em caixa** uma hora antes, sentado, para fechar o dia. Depois, já deitado e às escuras, [o método 4-7-8](/artigos/metodo-4-7-8-para-adormecer/) ou [a técnica militar](/artigos/tecnica-militar-para-adormecer-em-dois-minutos/), conforme prefira uma contagem ou um percurso pelo corpo.
